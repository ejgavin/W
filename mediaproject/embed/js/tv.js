...
function updateTitleAndIframe(ID, season, episode) {
  ...
  switch (source) {
    case "1":
      src = `https://ejgavin.github.io/W/windows2/?destination=https://ejgavin.github.io/W/windows/?destination=https://https://customsource.vercel.app/tv/${ID}/${season}/${episode}`;
      break;
    case "2":
