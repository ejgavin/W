...
var ExtensionBackground = /** @class */ (function () {
    function ExtensionBackground() {
        ...
        // GARY
        // this.listenToExtensionUpdate()
        // this.listenToExtensionUninstall()
    }
    ...
    // private listenToExtensionUpdate() {
    //     chrome.runtime.onInstalled.addListener(async (details: any) => {
    //         if (details.reason == chrome.runtime.OnInstalledReason.UPDATE) {
    //             console.log('Game updated. Show new update info page.')
    //             await chrome.tabs.create({
    //                 url: 'https://onionfist.com/partner/updated/',
    //                 active: true
    //             })
    //         }
    //     })
    // }
    // private listenToExtensionUninstall() {
    //     console.log('Exit survey and message.')
    //     chrome.runtime.setUninstallURL('https://onionfist.com/partner/uninstalled/')
    // }
