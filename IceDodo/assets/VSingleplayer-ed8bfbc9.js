...
import { M as MapUtils, F as FStorage, S as StorageKeyEnum, W as WEBSITE_URL, a as FINDER_MAX_RESULTS, U as ULTRAHARD_UNLOCK_AT_OVERALL_PERCENT, C as CupIdEnum, A as ALL_CUP_IDS, b as ALL_DIFFICULTIES, c as ALL_SKIN_IDS, d as SkinIdEnum, e as CupUtils, P as PageIdEnum, N as NewcomerUtils, f as UrlUtils, g as API_SERVER_URL, h as MiscUtils, i as CLOSE_BUTTON_TEXT, L as LinkEnum, j as StorageValueEnum, k as NEWCOMER_GRADUATE_AT_MAP_COMPLETION_COUNT, D as DeploymentUtils, l as ColorEnum, m as SoundFileEnum, R as RouteEnum, n as ALL_SOUND_FILE_PATHS, o as SettingsUtils, p as ArrayUtils, q as FGlobalManager, r as defineComponent, _ as _export_sfc, s as createElementBlock, t as createBaseVNode, u as createCommentVNode, v as createStaticVNode, w as openBlock, x as pushScopeId, y as popScopeId, z as MapPropertyUtils, B as toDisplayString, E as normalizeClass, G as Fragment, H as renderList, I as createVNode, J as resolveComponent, K as normalizeStyle, O as RecentMapUtils, Q as withDirectives, T as vModelText, V as withKeys, X as QueryKeyEnum } from "./index-97a13106.js";
...
class SkinUtils {
  ...
  static isPuzzleSkin(skinId) {
    return SkinUtils.getPuzzleSkinAnswer(skinId) != null;
  }
  static getPuzzleSkinAnswer(skinId) {
    switch (skinId) {
      case SkinIdEnum.PuzzleA:
        return "WOOOOF";
      case SkinIdEnum.PuzzleB:
        return "WOOORM";
      default:
        return null;
    }
  ...
  static async getRawSkinState(skinId, mainProgressState) {
    switch (skinId) {
      ...
      case SkinIdEnum.PointsB:
        return {
          name: "50pt",
          percent: mainProgressState.overallProgress.totalPoints / 50,
      ...
      case SkinIdEnum.PuzzleA:
        return {
          ...
          howToGet: "For my friends only. Secret code is on my oldest instagram post."
        };
      case SkinIdEnum.PuzzleB:
        return {
          name: "Chain",
          percent: await SkinUtils.getPuzzlePercent(skinId),
          howToGet: "Man of chain. Hint is also on my insta :p"
        };
    }
  }
}
...
((ApiEndpoints2) => {
  ...
  ((CompileLongMapUrl2) => {
    CompileLongMapUrl2.Path = "/api/compile_long_map_url.js";
  })(ApiEndpoints2.CompileLongMapUrl || (ApiEndpoints2.CompileLongMapUrl = {}));
  ((GetMapLeaderboard2) => {
...
class FSingleEndingManager extends FBaseEndingManager {
  ...
  onMapLoaded() {
    ...
    if (this.world.mainState.mapListing == null)
      return;
    this.writeMapAndMakerName(this.world.mainState.mapListing.cupId);
  }
...
class FMapLoader {
  ...
  static getUrl(mapId, mapUrl) {
    ...
    console.log("USED HE. DELETE THIS MESSAGE.");
    return DeploymentUtils.getMapCompilerUrlPrefix() + mapUrl;
  }
}
/*!
...
class FSingleCheatManager {
  constructor(world) {
    __publicField(this, "cheatCodeButtonDiv", document.getElementById("cheatCodeButton"));
    __publicField(this, "world");
    this.world = world;
    this.cheatCodeButtonDiv.onclick = () => this.enterCheatCode();
  }
  async enterCheatCode() {
    const cheatCode = prompt("cheat code:");
    switch (cheatCode) {
      case "oobe-beat-newcomer":
        await this.useCheatsFastForward();
        break;
      default:
        alert("unknown cheat code");
    }
  }
  async useCheatsFastForward() {
    for (const mapListing of MapUtils.getMapListings(CupIdEnum.Newcomer)) {
      await CompletedMapUtils.onMapCompleted(mapListing.mapId, 9999);
    }
    await this.world.reloadMainState();
    alert("done");
  }
}
class FSingleWorld extends FBaseWorld {
  constructor(mainState, createPopupItem, returnToMenuFromGame, changeCupByDeltaIndex, onClickMap, reloadMainState, isPopupShowing, closeCurrentPopup) {
    ...
    __publicField(this, "cheatManager");
    ...
    this.cheatManager = new FSingleCheatManager(this);
    this.asyncInit();
  }
...
const _withScopeId$8 = (n2) => (pushScopeId("data-v-31fa11aa"), n2 = n2(), popScopeId(), n2);
const _hoisted_1$d = { id: "gameMain" };
const _hoisted_2$d = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("canvas", { id: "renderCanvas" }, null, -1));
const _hoisted_3$c = { id: "overlay" };
const _hoisted_4$9 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("div", { id: "overlayLoadingScreen" }, [
...
const _hoisted_21$2 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("span", { id: "sponsorName" }, null, -1));
const _hoisted_22$2 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("a", {
...
const _hoisted_24$2 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("div", {
...
const VGame = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$d], ["__scopeId", "data-v-31fa11aa"]]);
...
const _withScopeId$7 = (n2) => (pushScopeId("data-v-2dc2a0c5"), n2 = n2(), popScopeId(), n2);
const _hoisted_1$c = { class: "mapListingName" };
const _hoisted_2$c = { class: "mapListingDescription" };
...
function _sfc_render$c(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("main", null, [
    createBaseVNode("div", {
      ...
      createBaseVNode("h2", _hoisted_1$c, toDisplayString(_ctx.mapListing.name), 1),
      createBaseVNode("p", _hoisted_2$c, [
        createBaseVNode("span", null, "Difficulty: " + toDisplayString(_ctx.mapListing.diff), 1),
        _hoisted_3$b,
        _ctx.mainState.mapCompletionDictionary[_ctx.mapListing.mapId].count === 0 ? (openBlock(), createElementBlock("span", _hoisted_4$8, "Click to play")) : _ctx.mainState.mapCompletionDictionary[_ctx.mapListing.mapId].count === 1 ? (openBlock(), createElementBlock("span", _hoisted_5$8, "Completed")) : _ctx.mainState.mapCompletionDictionary[_ctx.mapListing.mapId].count === 2 ? (openBlock(), createElementBlock("span", _hoisted_6$6, "Completed Twice")) : _ctx.mainState.mapCompletionDictionary[_ctx.mapListing.mapId].count >= 3 ? (openBlock(), createElementBlock("span", _hoisted_7$6, "Completed " + toDisplayString(_ctx.mainState.mapCompletionDictionary[_ctx.mapListing.mapId].count) + " times", 1)) : createCommentVNode("", true)
      ])
    ], 2)
  ]);
}
const VMapListing = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$c], ["__scopeId", "data-v-2dc2a0c5"]]);
...
function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.isStickyVisible ? (openBlock(), createElementBlock("main", _hoisted_1$b, [
    createBaseVNode("div", {
...
const VSticky = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$b], ["__scopeId", "data-v-92828c32"]]);
const _sfc_main$a = defineComponent({
  ...
  components: { VMapListing, VSticky }
});
...
const VMenu_vue_vue_type_style_index_0_scoped_b752023b_lang = "";
const _withScopeId$6 = (n2) => (pushScopeId("data-v-b752023b"), n2 = n2(), popScopeId(), n2);
...
const _hoisted_5$7 = { class: "topAreaContents" };
...
const _hoisted_27$1 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("a", {
  class: "buttonSmall",
  href: "https://onionfist.com/",
  target: "_blank"
}, "More games like this", -1));
const _hoisted_28$1 = { class: "socialIcons" };
const _hoisted_29$1 = ["href"];
const _hoisted_30$1 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("img", {
  src: _imports_8,
  alt: "discord"
}, null, -1));
const _hoisted_31$1 = [
...
const _hoisted_35 = { class: "footer" };
const _hoisted_36 = { class: "textSmall colorGray3" };
const _hoisted_37 = ["href"];
const _hoisted_38 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("span", { style: { "margin": "0px 10px" } }, "|", -1));
const _hoisted_39 = ["href"];
const _hoisted_40 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("p", { class: "textSmall colorGray3" }, [
  /* @__PURE__ */ createBaseVNode("span", null, "Onionfist 2023 | All Rights Reserved"),
  /* @__PURE__ */ createBaseVNode("br"),
  /* @__PURE__ */ createBaseVNode("span", null, "Ice Dodo Version 0.186")
], -1));
const _hoisted_41 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("main", _hoisted_1$a, [
    ...
    _ctx.mainState.isNewcomer ? (openBlock(), createElementBlock("div", _hoisted_24$1, [
      createBaseVNode("div", {
        class: "buttonSmall",
      ...
      createBaseVNode("a", {
        ...
        target: "_blank"
      }, "Please rate 5 stars", 8, _hoisted_26$1),
      _hoisted_27$1,
      createBaseVNode("div", {
        class: "buttonSmall",
    ...
    createBaseVNode("div", _hoisted_35, [
      createBaseVNode("p", _hoisted_36, [
        ...
        }, "Privacy Policy", 8, _hoisted_37),
        _hoisted_38,
        createBaseVNode("a", {
          class: "clickableText",
          href: _ctx.LinkEnum.TermsOfService
        }, "Terms of Service", 8, _hoisted_39)
      ]),
      _hoisted_40,
      _hoisted_41
    ]),
...
const VMenu = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$a], ["__scopeId", "data-v-b752023b"]]);
...
const VSettings_vue_vue_type_style_index_0_scoped_158bf306_lang = "";
const _withScopeId$4 = (n2) => (pushScopeId("data-v-158bf306"), n2 = n2(), popScopeId(), n2);
...
const _hoisted_5$6 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("div", {
  class: "clickableText",
  id: "cheatCodeButton"
}, " Enter cheat code ", -1));
...
const VSettings = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7], ["__scopeId", "data-v-158bf306"]]);
    ...
    createPuzzleSkinPopup(skinId) {
      ...
      const popupItem = {
        ...
        buttons: [{
          ...
          text: "Enter code",
          onClick: async () => {
            const guess = prompt("Enter secret code:");
            if (guess == null)
              return;
            if (guess.toUpperCase() != SkinUtils.getPuzzleSkinAnswer(skinId)) {
              alert("Wrong!");
              return;
            }
            alert("Skin unlocked!");
...
const VSkins_vue_vue_type_style_index_0_scoped_d52e68a5_lang = "";
const _withScopeId = (n2) => (pushScopeId("data-v-d52e68a5"), n2 = n2(), popScopeId(), n2);
...
const VSkins = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__scopeId", "data-v-d52e68a5"]]);
...
const VSingleplayer_vue_vue_type_style_index_0_scoped_280e79af_lang = "";
const _hoisted_1 = {
  key: 0,
  class: "main"
};
...
const VSingleplayer = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-280e79af"]]);
export {
