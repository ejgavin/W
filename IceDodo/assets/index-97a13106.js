...
const NEWCOMER_GRADUATE_AT_MAP_COMPLETION_COUNT = 15;
const ULTRAHARD_UNLOCK_AT_OVERALL_PERCENT = 0.9;
...
class DeploymentUtils {
  ...
  static getMapCompilerUrlPrefix() {
    return "https://icedodo-api.onionfist.com/api/compile_long_map_url.js?longUrl=";
  }
  static isExtension() {
...
const VBoot_vue_vue_type_style_index_0_scoped_b954703b_lang = "";
const _hoisted_1 = /* @__PURE__ */ createStaticVNode('<div class="bootContents" data-v-b954703b><p class="textSmall colorGray2" data-v-b954703b>Onionfist Studio</p><h1 class="textLarge colorPinkDark" data-v-b954703b>ICE DODO</h1><p class="textSmall" data-v-b954703b>Loading game ...</p><p class="textSmall colorGray2" data-v-b954703b>Version 0.186</p></div>', 1);
const _hoisted_2 = [
  _hoisted_1
];
...
const VBoot = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b954703b"]]);
function getRoutes() {
  const websiteAndExtensionRoutes = [
    ...
    },
    {
      ...
      component: () => __vitePreload(() => import("./VSingleplayer-ed8bfbc9.js"), true ? ["assets/VSingleplayer-ed8bfbc9.js","assets/VSingleplayer-6efbd531.css"] : void 0)
    }
  ];
...
var CupIdEnum = /* @__PURE__ */ ((CupIdEnum2) => {
  ...
  CupIdEnum2[CupIdEnum2["Vault"] = 33] = "Vault";
  CupIdEnum2[CupIdEnum2["Ultrahard"] = 34] = "Ultrahard";
  return CupIdEnum2;
})(CupIdEnum || {});
...
var SkinIdEnum = /* @__PURE__ */ ((SkinIdEnum2) => {
  ...
  SkinIdEnum2[SkinIdEnum2["PointsG"] = 52] = "PointsG";
  SkinIdEnum2[SkinIdEnum2["PercentA"] = 53] = "PercentA";
  SkinIdEnum2[SkinIdEnum2["PercentB"] = 54] = "PercentB";
  SkinIdEnum2[SkinIdEnum2["PercentC"] = 55] = "PercentC";
  SkinIdEnum2[SkinIdEnum2["PercentD"] = 56] = "PercentD";
  SkinIdEnum2[SkinIdEnum2["PercentE"] = 57] = "PercentE";
  SkinIdEnum2[SkinIdEnum2["PuzzleA"] = 58] = "PuzzleA";
  SkinIdEnum2[SkinIdEnum2["PuzzleB"] = 59] = "PuzzleB";
  return SkinIdEnum2;
})(SkinIdEnum || {});
...
class CondensedMapUtils {
  static getCondensedMapListings(cupId) {
    switch (cupId) {
      case CupIdEnum.Newcomer:
        return NEWCOMER_CONDENSED_MAPS;
      case CupIdEnum.Pilot:
        return [
          ...
          { diff: 3, id: "speed_desert", name: "Speed Desert" },
      ...
      case CupIdEnum.Tim:
        return [
          { diff: 1, id: "snek_level", name: "Snek Level" },
      ...
      case CupIdEnum.Golden:
        return [
          ...
          { diff: 5, id: "the_milky_way", name: "The Milky Way" },
          { diff: 6, id: "fever_dream", name: "Fever Dream" },
      ...
      case CupIdEnum.Fish:
        return [
          ...
          { diff: 4, id: "unnamed_2d_mario_stage", name: "Unnamed 2D Mario Stage" },
      ...
      case CupIdEnum.Thero:
        return [
          ...
          { diff: 7, id: "tartarus", name: "Tartarus" },
      ...
      case CupIdEnum.Crazy:
        return [
          ...
          { diff: 8, id: "raging_blue", name: "Raging Blue" }
        ];
      case CupIdEnum.June:
        return [
          ...
          { diff: 6, id: "theringedbox", name: "The Ringed Box" }
        ];
      case CupIdEnum.Sleepy:
        return [
      ...
      case CupIdEnum.Mango:
        return [
          ...
          { diff: 7, id: "childs_play", name: "Childs Play" },
      ...
      case CupIdEnum.Squirrel:
        return [
          ...
          { diff: 3, id: "trial_of_fire", name: "Trial of Fire" },
          ...
          { diff: 6, id: "trial_of_ice", name: "Trial of Ice" },
      ...
      case CupIdEnum.PainBumpo:
        return [
          ...
          { diff: 2, id: "on_big_island_live_only_one_cow", name: "on big island live only one cow" },
          { diff: 3, id: "red_lights", name: "Red Lights" },
          { diff: 3, id: "the_sulphurous_sea", name: "The Sulphurous Sea" },
          { diff: 3, id: "frozen_cave", name: "Frozen Cave" },
          { diff: 4, id: "cool_purple_crystals", name: "Cool Purple Crystals" },
          { diff: 4, id: "revolution", name: "REVOLUTION" },
          { diff: 5, id: "fire_down_the_toilet", name: "Fire Down The Toilet" },
          { diff: 4, id: "the_abyss", name: "The Abyss" },
          { diff: 5, id: "chicanery", name: "Chicanery" },
          { diff: 5, id: "eyes_in_the_water", name: "Eyes in the Water" },
          { diff: 5, id: "no_jokes", name: "no jokes" },
          { diff: 6, id: "dead_serious", name: "Dead Serious" },
          { diff: 6, id: "motion_medley", name: "Motion Medley" },
          { diff: 7, id: "i_spy_in_the_jungle", name: "i spy in the jungle" },
          { diff: 8, id: "podgelodge", name: "Podgelodge" },
          { diff: 9, id: "diamond_blade", name: "Diamond Blade" },
          { diff: 9, id: "radiance", name: "Radiance" },
          { diff: 9, id: "detecting_multiple_leviathan_class_lifeforms_in_the_region", name: "Detecting multiple leviathan class lifeforms in the region" }
        ];
      case CupIdEnum.Dark:
        return [
          { diff: 5, id: "oblivion", name: "Oblivion" },
          { diff: 5, id: "caution", name: "Caution: Slippery Floor" },
          { diff: 5, id: "borubon", name: "Bourbon, Scotch, and Beer!" },
          ...
          { diff: 9, id: "tritanopia", name: "Tritanopia" }
        ];
      case CupIdEnum.Insolence:
        return [
          { diff: 2, id: "freaking_out_random_unsuspecting_players", name: "50 Shades of Gray" },
          ...
          { diff: 5, id: "bridge_building", name: "Bridge Building" },
          { diff: 6, id: "warehouse_maintenance", name: "Warehouse Maintenance" },
          { diff: 6, id: "city_trail", name: "City Trail" },
          { diff: 6, id: "360", name: "360" },
          { diff: 7, id: "dune", name: "Dune" },
          { diff: 7, id: "pull_force", name: "pull force" },
          { diff: 7, id: "the_great_wall_of_dodo", name: "The Great Wall of Dodo" },
          { diff: 7, id: "deimos", name: "Deimos" },
          { diff: 7, id: "sewer_survival", name: "Sewer Survival" },
          { diff: 9, id: "cyber_domain", name: "Cyber Domain" },
      ...
      case CupIdEnum.Collab:
        return [
          ...
          { diff: 5, id: "blue_blues", name: "Blue Blues" },
          ...
          { diff: 6, id: "friendly_fire", name: "Friendly Fire" },
          ...
          { diff: 7, id: "path_to_paradise", name: "Path To Paradise" },
          ...
          { diff: 9, id: "phobos", name: "Phobos" },
          { diff: 9, id: "around_the_world", name: "Around the World" },
      ...
      case CupIdEnum.Ultrahard:
        return [
          { diff: 10, id: "evil_purple_crystals", name: "Evil Purple Crystals" },
          ...
          { diff: 11, id: "heliopolis", name: "Heliopolis" }
        ];
    }
  }
}
...
class MapUtils {
  ...
  static getAllMapIds() {
    ...
    for (const cupId of ALL_CUP_IDS) {
      const condensedMapListings = CondensedMapUtils.getCondensedMapListings(cupId);
...
class RecentMapUtils {
  static async onBoot() {
    ...
    await FStorage.setIfGetStringIsNull(StorageKeyEnum.LastVersionText, 0.186);
    ...
    await FStorage.set(StorageKeyEnum.LastVersionText, 0.186);
...
class NewcomerUtils {
  ...
  static createNewcomerHelpPopupItem(mainProgressState) {
    const mapsToComplete = NEWCOMER_GRADUATE_AT_MAP_COMPLETION_COUNT - mainProgressState.overallProgress.completedMaps;
    return {
      title: "Help",
      bodyAsHtml: `
...
class FEntryManager {
  static async init() {
    ...
    app.mount("#app");
    router.push("/");
    console.log("Ice dodo version: " + 0.186);
...
export {
  ...
  StorageValueEnum as j,
  NEWCOMER_GRADUATE_AT_MAP_COMPLETION_COUNT as k,
  ColorEnum as l,
  SoundFileEnum as m,
  ALL_SOUND_FILE_PATHS as n,
  SettingsUtils as o,
  ArrayUtils as p,
  FGlobalManager as q,
