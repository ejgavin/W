...
function UnityProgress(gameInstance, progress) {
    ...
    gameInstance.textProgress.innerHTML = 'Processing ' + Math.floor(progress * 100) + '%' + ' <img src="' + rootPath + '/gears.gif" class="spinner" />';

    /*
    if(progress>= 0.9 && progress<1)
    {
        gameInstance.textProgress.innerHTML = 'Running, Wait - ' + Math.floor(progress * 100) + '%' + ' <img src="' + rootPath + '/gears.gif" class="spinner" />';
    }
    else
    {
